...
namespace ShipIt.Repositories
{
    ...
    public class EmployeeRepository : RepositoryBase, IEmployeeRepository
    {
        ...
        public int GetWarehouseCount()
        {
            ...
            {
                var command = connection.CreateCommand();
                string EmployeeCountSQL = "SELECT COUNT(DISTINCT warehouse_id) FROM employees";
                command.CommandText = EmployeeCountSQL;
                connection.Open();
                var reader = command.ExecuteReader();
        ...
        {
            string sql = "SELECT name, warehouse_id, role, extension FROM employees WHERE name = @name";
        ...
        public IEnumerable<EmployeeDataModel> GetEmployeesByWarehouseId(int warehouseId)
        {
            ...
            string sql = "SELECT name, warehouse_id, role, extension FROM employees WHERE warehouse_id = @warehouse_id";
            var parameter = new NpgsqlParameter("@warehouse_id", warehouseId);
        ...
        public EmployeeDataModel GetOperationsManager(int warehouseId)
        {
            ...
            string sql = "SELECT name, warehouse_id, role, extension FROM employees WHERE warehouse_id = @warehouse_id AND role = @role";
            var parameters = new []
            {
        ...
        {
            string sql = "INSERT INTO employees (name, warehouse_id, role, extension) VALUES(@name, @warehouse_id, @role, @extension)";
